...
import 'package:api_control_flow/infraestructure/data_sources/bussines/product_api_data_source.dart';
...
class _ProductoScreenState extends State<ProductoScreen> {
  ...
  Future<void> _initDatabaseAndLoadRepositories() async {
    ...
    _productRepository = ProductApiDataSource(db: db);
    await _loadProducts();
  }
            ...
            TextButton(
              onPressed: () async {
                await _productRepository
                    .deleteProduct(product.id!); // Eliminar el proveedor
