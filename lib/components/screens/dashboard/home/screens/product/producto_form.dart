...
import 'package:api_control_flow/db/repository/category_repository.dart';
...
class _InsumoFormScreenState extends State<InsumoFormScreen> {
  ...
  Future<void> _loadCategories() async {
    final categorias = await _categoryRepository.obtenerCategorias();
    setState(() {
  ...
  Future<void> _initDatabaseAndRepository() async {
    ...
    _categoryRepository = CategoryRepository(db: db);
